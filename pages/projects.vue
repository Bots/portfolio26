<template>
  <div class="py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Stats bar -->
      <div class="flex flex-wrap gap-6 mb-10 p-5 bg-zinc-50 rounded-xl border border-zinc-100 dark:border-zinc-800">
      ...
      <div class="mb-10 p-5 bg-zinc-50 rounded-xl border border-zinc-100 dark:border-zinc-800">
